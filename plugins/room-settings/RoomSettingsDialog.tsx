        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-md">
                ...
                <div className="space-y-6 mt-4">
                    ...
                    {/* Background Image */}
                    <div className="space-y-4">
                        <h3 className="text-sm font-medium text-muted-foreground border-b pb-2">背景图片 (仅本地有效)</h3>
                        <div className="space-y-3">
                            {currentBgImage ? (
                                <div className="relative rounded-lg overflow-hidden border border-border">
                                    <img src={currentBgImage} alt="背景预览" className="w-full h-24 object-cover" />
                                    <button
                                        onClick={() => onBgImageChange("")}
                                        className="absolute top-1 right-1 bg-destructive text-destructive-foreground rounded-full w-6 h-6 flex items-center justify-center hover:opacity-80"
                                        title="清除背景"
                                    >
                            ...
                            />
                            <p className="text-[10px] text-muted-foreground">支持 JPG / PNG / WebP，建议 ≤ 5MB</p>
                        </div>
                    </div>
